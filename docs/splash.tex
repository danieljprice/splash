...
%HEVEA\htmlfoot{\@hr{\textwidth}{1pt}\textsc{SPLASH}: A visualisation tool for SPH data \copyright   2004--2010 Daniel Price. \newline \url{http://users.monash.edu.au/~dprice/splash/}}
...
\item Straightforward production of both bitmap (png) and vector (Postscript, PDF) images which can then be
...
\section{User contributions / Wishlist for future improvements}%HEVEA\cutname{wishlist.html}
