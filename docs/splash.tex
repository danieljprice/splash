...
\begin{table}[h!]
\begin{tabular}{llll}
Compiler & Environment variable & Setting for big endian & little endian \\
\hline
\verb+g95+ & \verb+G95_ENDIAN+ & \verb+BIG+ & \verb+LITTLE+  \\
\verb+gfortran+ & \verb+GFORTRAN_CONVERT_UNIT+ & \verb+big_endian+ & \verb+little_endian+ \\
