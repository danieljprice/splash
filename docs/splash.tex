...
Command line options:
 ...
 to format       : convert SPH data file(s) to different format
                   example usage "ssplash to ascii" for sphNG to ascii conversion
\end{verbatim}
...
\label{sec:colourbarstyle}
 The colour bar style (ie. vertical vs. horizontal, plot-hugging vs. non plot-hugging, one-sided vs. two-sided) can be changed via the ``colour bar options'' option in the r)ender submenu. If you want a different style implemented, email me!
