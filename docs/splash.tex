...
\subsection{SPLASH, the paper}
 The algorithms implemented in SPLASH are not described here, but instead described in a paper \citep{splashpaper} to be published in the Publications of the Astronomical Society of Australia, available from:
