...
\subsection{Licence}
 SUPERSPHPLOT is released under the terms of the GNU General Public License (GPL). You should have received
 a copy with this distribution, other
...
\end{quote}
although there is another, apparently unrelated project at
\begin{quote}
\url{www.gfortran.org}
\end{quote}
