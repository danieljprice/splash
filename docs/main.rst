...
+-----------------------------------+-----------------------------------+
| |First stage in the star          | |First stage in the star          |
| formation figure tutorial: a      | formation figure tutorial: a      |
| simple render plot of density     | simple render plot of density     |
| (left) and with a log axis after  | (left) and with a log axis after  |
| having placed cursor over colour  | having placed cursor over colour  |
| bar and pressed ‘l’ (right)|      | bar and pressed ‘l’ (right)|      |
+-----------------------------------+-----------------------------------+
...
+-----------------------------------+-----------------------------------+
| |Second stage in the star         | |Second stage in the star         |
| formation figure tutorial: having | formation figure tutorial: having |
| applied physical units, zooming   | applied physical units, zooming   |
| in and pressing ‘a’ on the colour | in and pressing ‘a’ on the colour |
| bar (left) and having changed the | bar (left) and having changed the |
| colour scheme (right)|            | colour scheme (right)|            |
+-----------------------------------+-----------------------------------+
...
producing the plot shown in the right hand panel of
Figure \ `[fig:starpart2] <#fig:starpart2>`__. Pressing ‘s’ in
...
+-----------------------------------+-----------------------------------+
| |Third stage in the star          | |Third stage in the star          |
| formation figure tutorial: having | formation figure tutorial: having |
| turned sink particle plotting on  | turned sink particle plotting on  |
| (left) replacing the axes with a  | (left) replacing the axes with a  |
...
The following is an example plot taken from :raw-latex:`\citet{pb07}`.
...
+-----------------------------------+-----------------------------------+
| |First stage in the               | |First stage in the               |
| multi-panelled figure tutorial: a | multi-panelled figure tutorial: a |
| simple render plot of density     | simple render plot of density     |
| (left) and with a log axis after  | (left) and with a log axis after  |
| having placed cursor over colour  | having placed cursor over colour  |
| bar and pressed ‘l’ (right)|      | bar and pressed ‘l’ (right)|      |
...
+-----------------------------------+-----------------------------------+
| |Second stage in the              | |Second stage in the              |
| multi-panelled figure tutorial:   | multi-panelled figure tutorial:   |
| having changed the axes into      | having changed the axes into      |
| physical units (left) and zooming | physical units (left) and zooming |
| in and adjusting the colour bar   | in and adjusting the colour bar   |
| (right).|                         | (right).|                         |
+-----------------------------------+-----------------------------------+
...
+-----------------------------------+-----------------------------------+
| |First stage in the surface       | |First stage in the surface       |
| rendering tutorial: a simple      | rendering tutorial: a simple      |
| render plot of density (left) and | render plot of density (left) and |
| with a log axis after having      | with a log axis after having      |
| placed cursor over colour bar and | placed cursor over colour bar and |
| pressed ‘l’ (right)|              | pressed ‘l’ (right)|              |
+-----------------------------------+-----------------------------------+
...
+-----------------------------------+-----------------------------------+
| |Second stage in the surface      | |Second stage in the surface      |
| rendering tutorial: after         | rendering tutorial: after         |
| adjusting the rotation angle      | adjusting the rotation angle      |
| (left) and with 3D surface        | (left) and with 3D surface        |
| rendering turned on (which also   | rendering turned on (which also   |
| turns on 3D perspective) and      | turns on 3D perspective) and      |
| having adjusted the colour bar    | having adjusted the colour bar    |
| limits (right)|                   | limits (right)|                   |
+-----------------------------------+-----------------------------------+
...
+-----------------------------------+-----------------------------------+
| |Third stage in the surface       | |Third stage in the surface       |
| rendering tutorial: after         | rendering tutorial: after         |
| adjusting the xy and colour bar   | adjusting the xy and colour bar   |
| limits interactively (left) and   | limits interactively (left) and   |
| increasing the number of pixels   | increasing the number of pixels   |
| and having turned the axes off    | and having turned the axes off    |
| (right)|                          | (right)|                          |
+-----------------------------------+-----------------------------------+
...
panel of Figure \ `[fig:surfpart3] <#fig:surfpart3>`__.
...
also, using the -e option on the command line means that any
