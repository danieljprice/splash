...
INTEGER*8 FUNCTION h5pt_isvalid_( ihandle )
...
!! \return 0 on success or error code
!<
INTEGER*8 FUNCTION h5pt_getdatasetinfo (filehandle,index,name,data_type,nelem)
    INTEGER*8, INTENT(IN) :: filehandle         !< the handle returned during file open
    INTEGER*8, INTENT(IN) :: index              !< index of dataset to query (starting from 0)
    CHARACTER(LEN=*), INTENT(OUT) :: name       !< buffer to read the dataset name into 
...
!! \return 0 on success or error code
!<
INTEGER*8 FUNCTION h5pt_writefilestring (filehandle,name,value)
    INTEGER*8, INTENT(IN) :: filehandle         !< the handle returned during file open
...
!! \return 0 on success or error code
!<
INTEGER*8 FUNCTION h5pt_writestepstring (filehandle,name,value)
    INTEGER*8, INTENT(IN) :: filehandle         !< the handle returned during file open
    CHARACTER(LEN=*), INTENT(IN) :: name        !< the name of the attribute
    CHARACTER(LEN=*), INTENT(IN) :: value       !< the string value to store
END FUNCTION
...
!! \return 0 on success or error code
!<
INTEGER*8 FUNCTION h5pt_readfilestring (filehandle,name,value)
    INTEGER*8, INTENT(IN) :: filehandle         !< the handle returned during file open
    CHARACTER(LEN=*), INTENT(IN) :: name        !< the name of the attribute
...
!! \return 0 on success or error code
!<
INTEGER*8 FUNCTION h5pt_readstepstring (filehandle,name,value)
    INTEGER*8, INTENT(IN) :: filehandle         !< the handle returned during file open
    CHARACTER(LEN=*), INTENT(IN) :: name        !< the name of the attribute
    CHARACTER(LEN=*), INTENT(OUT) :: value      !< buffer to read the string value into
END FUNCTION
...
!! \return 0 on success or error code
!<
INTEGER*8 FUNCTION h5pt_getstepattribinfo (filehandle,idx,name,nelem)
    INTEGER*8, INTENT(IN) :: filehandle         !< the handle returned during file open
...
!! \return 0 on success or error code
!<
INTEGER*8 FUNCTION h5pt_getfileattribinfo (filehandle,idx,name,nelem)
    INTEGER*8, INTENT(IN) :: filehandle         !< the handle returned during file open
    INTEGER*8, INTENT(IN) :: idx              !< index of the attribute to query (starting from 0)
    CHARACTER(LEN=*), INTENT(OUT) :: name       !< buffer to read the attribute name into
    INTEGER*8, INTENT(OUT) :: nelem             !< number of elements in the attribute's array
...
!! \return 0 on success or error code
!>
INTEGER*8 FUNCTION h5pt_writefileattrib_r8 ( filehandle, name, data, nelem)
...
!! \return 0 on success or error code
!>
INTEGER*8 FUNCTION h5pt_writefileattrib_r4 ( filehandle, name, data, nelem)
    INTEGER*8, INTENT(IN) :: filehandle !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: name !< the name of the attribute
...
!! \return 0 on success or error code
!>
INTEGER*8 FUNCTION h5pt_writefileattrib_i8 ( filehandle, name, data, nelem)
    INTEGER*8, INTENT(IN) :: filehandle !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: name !< the name of the attribute
...
!! \return 0 on success or error code
!>
INTEGER*8 FUNCTION h5pt_writefileattrib_i4 ( filehandle, name, data, nelem)
    INTEGER*8, INTENT(IN) :: filehandle !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: name !< the name of the attribute
...
!! \return 0 on success or error code
!>
INTEGER*8 FUNCTION h5pt_writestepattrib_r8 ( filehandle, name, data, nelem)
    INTEGER*8, INTENT(IN) :: filehandle !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: name !< the name of the attribute
    REAL*8, INTENT(IN) :: data(*) !< the array of data to write into the attribute
    INTEGER*8, INTENT(IN) :: nelem !< the number of elements in the array
...
!! \return 0 on success or error code
!>
INTEGER*8 FUNCTION h5pt_writestepattrib_r4 ( filehandle, name, data, nelem)
    INTEGER*8, INTENT(IN) :: filehandle !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: name !< the name of the attribute
    REAL*4, INTENT(IN) :: data(*) !< the array of data to write into the attribute
    INTEGER*8, INTENT(IN) :: nelem !< the number of elements in the array
...
!! \return 0 on success or error code
!>
INTEGER*8 FUNCTION h5pt_writestepattrib_i8 ( filehandle, name, data, nelem)
    INTEGER*8, INTENT(IN) :: filehandle !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: name !< the name of the attribute
    INTEGER*8, INTENT(IN) :: data(*) !< the array of data to write into the attribute
    INTEGER*8, INTENT(IN) :: nelem !< the number of elements in the array
...
!! \return 0 on success or error code
!>
INTEGER*8 FUNCTION h5pt_writestepattrib_i4 ( filehandle, name, data, nelem)
    INTEGER*8, INTENT(IN) :: filehandle !< the handle returned at file open
    CHARACTER(LEN=*), INTENT(IN) :: name !< the name of the attribute
    INTEGER*4, INTENT(IN) :: data(*) !< the array of data to write into the attribute
    INTEGER*8, INTENT(IN) :: nelem !< the number of elements in the array
